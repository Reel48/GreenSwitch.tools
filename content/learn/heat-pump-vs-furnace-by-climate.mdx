...
- You qualify for state-administered heat pump rebates (up to $8,000 for income-qualifying households in participating states)
...
The incentive landscape changed at the end of 2025. The federal 25C tax credit — 30% of installation cost, up to $2,000 for qualifying heat pumps — **ended for systems placed in service after December 31, 2025** under the One Big Beautiful Bill Act, so new installations no longer get a federal tax credit. What remains:

- **HOMES/HEEHRA rebates:** These state-administered Home Energy Rebates continue in participating states — up to $8,000 for income-qualified households for heat pump installation
- **State and utility programs:** Many states and utilities offer additional rebates of $500–$3,000

For income-qualified households in participating states, these remaining programs can still cut installation costs substantially. Other buyers should now run the numbers at full installed price — check your state energy office and utility before assuming any discount.
...
Heat pumps save money for most American homeowners, with the strongest case in warm-to-moderate climates where they replace both a furnace and an air conditioner. In cold climates, modern cold-climate heat pumps are competitive with gas furnaces, and state rebate programs — the main incentives still standing after the federal 25C credit ended on December 31, 2025 — can tip the scale for qualifying households. The key variables are your local electricity and gas prices, climate zone, and available state rebates.
