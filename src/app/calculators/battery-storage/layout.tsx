...
export const metadata: Metadata = {
  ...
  description:
    "Evaluate home battery storage ROI with time-of-use rate arbitrage, solar pairing, backup power value, and state incentives. See your payback period and 15-year savings.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Evaluate home battery ROI with TOU rate arbitrage, solar pairing, and state incentives.",
